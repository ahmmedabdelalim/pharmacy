    ...
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequest('{{url('/')}}/branch/product/get-categories?parent_id=' + category + '&&sub_category=' + sub_category, 'sub-categories');
                getRequest('{{url('/')}}/branch/product/get-categories?parent_id=' + sub_category + '&&sub_category=' + sub_sub_category, 'sub-sub-categories');
            }, 1000)
        });
    </script>
