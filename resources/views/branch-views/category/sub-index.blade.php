                                    ...
                                    <td>
                                        @if($category['status']==1)
                                            <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                 onclick="location.href='{{route('branch.category.status',[$category['id'],0])}}'">
                                                <span
                                                    class="legend-indicator bg-success"></span>{{\App\CentralLogics\translate('active')}}
                                            </div>
                                        @else
                                            <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                 onclick="location.href='{{route('branch.category.status',[$category['id'],1])}}'">
                                                <span
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('branch.category.edit',[$category['id']])}}">{{\App\CentralLogics\translate('edit')}}</a>
...
@push('script_2')
    ...
    <script>
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('branch.category.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
