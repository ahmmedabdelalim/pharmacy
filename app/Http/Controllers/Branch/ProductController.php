...
class ProductController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $query = pharmacy_product::where(function ($q) use ($key) {
            ...
            $query = pharmacy_product::where('pharmacy_id',   auth()->guard('branch')->user()->id)->latest();
        }
    ...
    {
        $key = explode(' ', $request['search']);
        $products = pharmacy_product::where(function ($q) use ($key) {
            foreach ($key as $value) {
    ...
    {
        $product = pharmacy_product::where(['id' => $id])->first();
    ...
    {
        $product = pharmacy_product::withoutGlobalScopes()->with('translations')->find($id);
